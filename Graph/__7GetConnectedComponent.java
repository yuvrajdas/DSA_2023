...
package Graph;
import java.util.*;
public class __7GetConnectedComponent{
    ...
    public static void getConnectedCom(ArrayList<Edge> graph[], boolean visited[], int src, ArrayList<Integer> comp){
        visited[src] = true;
        comp.add(src);
        ...
        for(Edge e : graph[src]){
            ...
            if(visited[nbr] == false){
                getConnectedCom(graph, visited, nbr, comp);
            }
        }
    }
    public static void main(String[] args) {
        ...
        for(int i=0; i<v; i++){
            if(visited[i] == false){
                ...
                getConnectedCom(graph, visited, i, comp);       
                comps.add(comp);
            }
        }
